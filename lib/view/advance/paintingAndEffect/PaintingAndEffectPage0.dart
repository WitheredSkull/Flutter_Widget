...
///所有的文本部件
class PaintingAndEffectPage0 extends StatefulWidget {
  ItemViewExplainBean data;

  PaintingAndEffectPage0(this.data);

  @override
  State<StatefulWidget> createState() {
    return PaintingAndEffectPage0State();
  }
}

class PaintingAndEffectPage0State
    extends BaseCodeState<PaintingAndEffectPage0> {
  @override
  Widget body() {
