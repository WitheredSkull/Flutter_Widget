...
///所有的文本部件
class PaintingAndEffectPage3 extends StatefulWidget {
  ItemViewExplainBean data;

  PaintingAndEffectPage3(this.data);

  @override
  State<StatefulWidget> createState() {
    return PaintingAndEffectPage3State();
  }
}

class PaintingAndEffectPage3State
    extends BaseCodeState<PaintingAndEffectPage3> {
  @override
  Widget body() {
