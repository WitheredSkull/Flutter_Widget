...
import 'package:flutter_widget/view/widget/paintingAndEffects/CustomPaintWidget.dart';
...
///所有的文本部件
class PaintingAndEffectPage2 extends StatefulWidget {
  ItemViewExplainBean data;

  PaintingAndEffectPage2(this.data);

  @override
  State<StatefulWidget> createState() {
    return PaintingAndEffectPage2State();
  }
}

class PaintingAndEffectPage2State
    extends BaseCodeState<PaintingAndEffectPage2> {
  @override
  Widget body() {
